...
This project allows you to design forms in flowable-modeler and render them on screen. 

## Use your instance of flowable-modeler

To use your already working version of flowable-modeler open `package.json` and change the proxy section to point to your server. 
Then run:
```
yarn
yarn start
